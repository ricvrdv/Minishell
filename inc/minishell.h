...
int				execute_node(t_tree *tree, t_minishell *mini, int in_fd,
					int out_fd);
int				execute_pipe(t_tree *tree, t_minishell *mini);
int				execute_redirect(t_tree *tree, t_minishell *mini, int in_fd,
					int out_fd);
int				execute_command(t_tree *node, t_minishell *mini, int in_fd,
					int out_fd);
...
int				execute_last_command(t_tree *node, t_minishell *mini,
					int in_fd);
int				create_and_fork_command(t_tree *node, t_minishell *mini,
					int in_fd);
...
void			read_heredoc_expand(int fd, const char *delimiter,
					t_minishell *mini);
